...
@Component({
  selector: 'app-registro-egreso-categoria',
  templateUrl: './registro-egreso-categoria.component.html',
  styleUrls: ['./registro-egreso-categoria.component.css']
})
export class RegistroEgresoCategoriaComponent implements OnInit {
